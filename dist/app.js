...
var _App = function (_BaseComponent) {
  ...
  function _App() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _App.__proto__ || Object.getPrototypeOf(_App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _this.config = {
      pages: ['pages/shopDetail/shopDetail', 'pages/orderDetail/orderDetail', 'pages/my/my', 'pages/editAdress/editAdress', 'pages/orderList/orderList', 'pages/goodsCar/goodsCar', 'pages/liquidation/liquidation', 'pages/index/index', 'pages/selectAdress/selectAdress'],
      window: {
  ...
  _createClass(_App, [{
    ...
    value: function componentDidShow() {
      ...
      _taroWeapp2.default.setTabBarBadge({ index: 1, text: carsObj['num'].toString() });
    }
  }, {
